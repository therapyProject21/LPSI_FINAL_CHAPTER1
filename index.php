  ...
  <table class="min-w-full divide-y divide-gray-200 text-sm">
    ...
    <div class="mt-4">
     ...
     <div class="flex overflow-x-scroll space-x-4 mt-2">
      ...
      <img alt="Recommendation image 2" class="h-24 w-full rounded" height="150" src="toksmu/<?php echo htmlspecialchars($rowFlayer['gambar1']); ?>" width="150"/>
        <p class="text-gray-700 mt-2"><?php echo htmlspecialchars($rowInformasi['teks1']); ?></p>
      </a>
      <!-- Recommendation Item 2 -->
      <a class="flex-shrink-0 w-40 bg-white shadow-md rounded-lg p-2 relative" href="#">
      <img alt="Recommendation image 2" class="h-24 w-full rounded" height="150" src="toksmu/<?php echo htmlspecialchars($rowFlayer['gambar2']); ?>" width="150"/>
       <p class="text-gray-700 mt-2"><?php echo htmlspecialchars($rowInformasi['teks2']); ?></p>
      </a>
      <!-- Recommendation Item 3 -->
      <a class="flex-shrink-0 w-40 bg-white shadow-md rounded-lg p-2 relative" href="#">
      <img alt="Recommendation image 2" class="h-24 w-full rounded" height="150" src="toksmu/<?php echo htmlspecialchars($rowFlayer['gambar3']); ?>" width="150"/>
      <p class="text-gray-700 mt-2"><?php echo htmlspecialchars($rowInformasi['teks3']); ?></p>
      </a>
      <!-- Recommendation Item 4 -->
      <a class="flex-shrink-0 w-40 bg-white shadow-md rounded-lg p-2 relative" href="#">
      <img alt="Recommendation image 2" class="h-24 w-full rounded" height="150" src="toksmu/<?php echo htmlspecialchars($rowFlayer['gambar4']); ?>" width="150"/>
      <p class="text-gray-700 mt-2"><?php echo htmlspecialchars($rowInformasi['teks4']); ?></p>
      </a>
      <!-- Recommendation Item 5 -->
      <a class="flex-shrink-0 w-40 bg-white shadow-md rounded-lg p-2 relative" href="#">
      <img alt="Recommendation image 2" class="h-24 w-full rounded" height="150" src="toksmu/<?php echo htmlspecialchars($rowFlayer['gambar5']); ?>" width="150"/>
      <p class="text-gray-700 mt-2"><?php echo htmlspecialchars($rowInformasi['teks5']); ?></p>
      </a>
      <!-- Recommendation Item 6 -->
      <a class="flex-shrink-0 w-40 bg-white shadow-md rounded-lg p-2 relative" href="#">
      <img alt="Recommendation image 2" class="h-24 w-full rounded" height="150" src="toksmu/<?php echo htmlspecialchars($rowFlayer['gambar6']); ?>" width="150"/>
      <p class="text-gray-700 mt-2"><?php echo htmlspecialchars($rowInformasi['teks6']); ?></p>
      </a>
     </div>
    </div>
